...
``agon.detection.botsort_tracker`` for that alternative.
...
from agon.geometry.bbox import BBox, get_center_of_bbox, get_foot_position
...
def run_detection_and_tracking(
    ...
    export -- see ``agon.export`` for that. JSON, not pickle:
