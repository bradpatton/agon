...
from soccer_analysis.broadcast.frame_filter import FrameClassification, classify_frame
...
from soccer_analysis.io.video import (
    Frame,
...
from soccer_analysis.viz.annotate import draw_annotations, draw_annotations_on_frame
...
def _classify_frames(
    ...
    Otherwise classifies every frame (see soccer_analysis.broadcast) and,
...
def run_pipeline(
    ...
    (ads/replays/graphics -- see soccer_analysis.broadcast) before
